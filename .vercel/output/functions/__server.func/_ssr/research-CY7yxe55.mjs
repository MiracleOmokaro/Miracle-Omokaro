...
//#region node_modules/.nitro/vite/services/ssr/assets/research-CY7yxe55.js
...
var RESEARCH = [{
	...
	status: "in-progress",
	summary: "A working research question at the intersection of Polymorph and Pentagon Cyber: measure whether constrained generation (CSP, authz defaults, dependency policy) changes the vulnerability profile of first-ship SME sites versus typical agency output.",
	body: [
		{
	...
	venue: "Planned note",
	status: "planned",
	summary: "Polymorph uses voice agents for outreach. This note will treat that as a security and ethics object: impersonation risk, recording consent across Gulf jurisdictions, and what “the power of Grok” does not excuse.",
	body: [{
		heading: "Scope",
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SiteShell, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h1", {
				...
				children: "Notes that can survive a reviewer."
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
				className: "mt-5 text-lg leading-relaxed text-muted",
				children: "Public drafts on the way to student tracks, workshops, and practitioner bodies — IEEE Computer Society / Security & Privacy, and ASIS International among them. Claims stay smaller than the evidence."
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				className: "mt-14 space-y-16",
				children: RESEARCH.map((post) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("article", {
					...
					children: [
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
							className: "mt-6",
							children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ProseBlocks, { blocks: post.body })
						})
					]
				}, post.id))
			})
